...
class Pop():
    ...
    def create_random_population(self, rows_required, hospitals, fix_hospitals):
        ...
        # remove solutions with greater than maximum permitted population
        mask = population.sum(axis=1) <= self.max_pop
    ...
    def generate_child_population(
        ...
        # remove solutoins with greater than maximum permitted population
        mask = child_population.sum(axis=1) <= self.max_pop
        child_population = child_population[mask]
